...
export const userRoutes = (
    ...
    userRouter.get('/getall', authenticateToken, authorizeAdmin, userController.getAll)
    userRouter.patch('/update', authenticateToken, userController.update)
    userRouter.post('/delete', authenticateToken, userController.changeStatus)
    userRouter.delete('/erase', authenticateToken, authorizeAdmin, userController.clean)
    ...
    userRouter.post('/comment/:id', authenticateToken, userController.saveComment)
    userRouter.delete('/comment/:id', authenticateToken, userController.deleteComment)
